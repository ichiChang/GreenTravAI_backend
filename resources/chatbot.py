...
class EasyMessage(MethodView):
    ...
    def post(self, user_data):
        ...
        if "逛街" in user_query:
            ...
            hotel_recommendations = "# 台北市熱門飯店推薦 (2024年10月20日至10月23日)以下是符合您入住人數和預算範圍（1500~5000 TWD）的飯店推薦：1. **台北北門世民酒店 (CitizenM Taipei North Gate)**- **價格**：約3800 TWD- **評價**：8.8- **特色**：現代設計、便利的交通，靠近台北車站。- [預訂連結](https://www.citizenm.com)2. **君品酒店 (Palais de Chine Hotel)**- **價格**：約5000 TWD- **評價**：8.7- **特色**：結合法國浪漫和台灣文化的豪華住宿。- [預訂連結](https://www.palaisdechinehotel.com)3. **捷絲旅台北西門館 (Just Sleep Taipei Ximen)**- **價格**：約2600 TWD- **評價**：8.7- **特色**：提供舒適的住宿，位置便利，靠近西門町。- [預訂連結](https://www.justsleephotels.com)4. **金普頓大安酒店 (Kimpton DaAn Hotel Taipei)**- **價格**：約5700 TWD- **評價**：8.4- **特色**：獨特設計、優質服務，接近大安森林公園。- [預訂連結](https://www.ihg.com)這些飯店都擁有良好的評價和便利的地理位置，適合您在台北的住宿需求。希望您有個愉快的旅程！"
            response = {
