...
class EasyMessage(MethodView):
    ...
    def post(self, user_data):
        ...
        elif "一日遊" in user_query:
            plan_recommendation ="""**第一天行程**
1. 早餐  
**地址:** 台北市中正區忠孝東路一段108號2樓 
**簡介:** 台北著名的早餐店，以傳統的豆漿和燒餅油條聞名。  
**地點名稱:** 阜杭豆漿 
**停留時間:** 1 小時

2. 景點參觀  
**地址:** 臺北市士林區雨聲街120號  
**簡介:** 位於台北市的綠色生態園區，提供豐富的自然景觀和文化體驗。  
**地點名稱:** 芝山文化生態綠園  
**停留時間:** 1 小時 30 分

3. 午餐  
**地址:** 台北市信義區光復南路260巷39號  
**簡介:** 氣氛輕鬆的餐廳採用復古時尚風裝潢，並供應各式種類的餐點。  
**地點名稱:** ABV Bar & Kitchen 地中海餐酒館 台北創始店
**停留時間:** 1 小時 30 分

4. 景點參觀  
**地址:** 台北市士林區至善路二段221號  
**簡介:** 擁有豐富的中國古代藝術珍品，為世界著名的博物館之一。
**地點名稱:** 國立故宮博物院  
**停留時間:** 3 小時

5. 晚餐  
**地址:** 105台灣台北市松山區饒河街  
**簡介:** 歷史悠久的熱鬧夜市，有各式商店和街頭小吃攤。
**地點名稱:** 饒河街觀光夜市
**停留時間:** 2 小時

**總結**
行程安排了台北市的綠色景點和文化古蹟參觀，並在晚上體驗饒河夜市的市井風情。
"""     
        response = {
                "Message": plan_recommendation,
                "Recommendation": [],
            }
...
class EasyGreenMessage(MethodView):
    ...
    def post(self, user_data):
        ...
        if "逛街" in user_query:
            ...
            green_plan_recommendation ="""**第一天行程**
1. 早餐  
