...
systemMessage = SystemMessage(
    content="""You are a search consistent, who can do detailed research on ant topic and produce facts. 
...
def search(q):
    ...
    params = {"engine": "google", "gl": "tw", "hl": "zh-tw", "q": q, "api_key": ""}
...
agentExecutor = AgentExecutor(
    agent=search_agent, tools=tools, memory=memory, verbose=True
)
